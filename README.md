...
แผนการปรับโครงสร้างเมื่อข้อมูลหรือจำนวนผู้ใช้เพิ่มขึ้นอยู่ที่
[`docs/SCALING_ROADMAP.md`](docs/SCALING_ROADMAP.md)
...
│   ├── swing_backtest.json         ← ผล walk-forward validation ของ Swing
...
│   ├── backtest_swing.py           ← ทดสอบ Swing แบบ point-in-time
