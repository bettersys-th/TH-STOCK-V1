...
class ToolkitBuildTests(unittest.TestCase):
    def test_cycle_and_dca_payloads_are_lazy_loaded(self):
        ...
        self.assertIn("const {SCENARIO_PRESETS,boardLotPurchase,simulateScenario,contributionPerPeriod,assessMonthlyBudget,rankAffordableAlternatives,analyzeOutcomeTimeline}=window.DcaDomain", html)
